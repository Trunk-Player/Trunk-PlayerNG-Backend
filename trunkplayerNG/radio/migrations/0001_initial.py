    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('UUID', models.UUIDField(db_index=True, default=uuid.uuid4, unique=True)),
                ('time', models.DateTimeField(default=datetime.datetime(2021, 10, 24, 22, 54, 27, 846322))),
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(related_name='SRTGAllow', to='radio.TalkGroup'),
        ),
        migrations.AddField(
            model_name='systemrecorder',
            name='talkgroupsDenyed',
            field=models.ManyToManyField(related_name='SRTGDeny', to='radio.TalkGroup'),
        ),
        migrations.AddField(
            model_name='systemrecorder',
            name='user',
