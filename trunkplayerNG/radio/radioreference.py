...
class RR():
    ...
    def fetch_system_talkgroups(self):
        ...
        myAuthInfo = auth_type(username=self.rrUser, password=self.rrPass, appKey='28801163', version='15',
                            style='rpc')
        ...
        result = Talkgroups_type(client.service.getTrsTalkgroups(self.rrSystemId, 0, 0, 0, myAuthInfo))
        return result
    ...
    def load_system(self, SystemUUID):
        ...
        for talkgroup in RR_TGs:
            ...
            try:
                UUID = uuid.uuid5(uuid.NAMESPACE_DNS, f"{SystemUUID}+{str(talkgroup['tgDec'])}")           
