...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument("--confirm", action='store_true', help="Confirm this is really what you want todo")
        parser.add_argument("--rr_username")
        parser.add_argument("--rr_password")
...
API USER LOGINS:
    ...
    User 4 (Standard User): 
        ...
        restricted_acl: SystemACL = SystemACL.objects.create(
            UUID=uuid.uuid4(),
            name='restricted', public=False, users=[user3.userProfile]
        )
        restricted_acl.save()
        ...
        system1_rr = RR(system1.rr_system_id, args.rr_username, args.rr_password)
        system2_rr = RR(system2.rr_system_id, args.rr_username, args.rr_password)
        system3_rr = RR(system3.rr_system_id, args.rr_username, args.rr_password)
        ...
        system_forwarder1: SystemForwarder = SystemForwarder.objects.create(
            ...
            forward_systems = [system1,system3]
        )
        ...
        system_forwarder2: SystemForwarder = SystemForwarder.objects.create(
            ...
            forward_systems = [system1,system2]
        )
...
System Recorder API Keys:
    ...
    System Recorder 3: 
        ...
        incident1: Incident = Incident.objects.create(
            ...
            system=system1,
            transmission = [transmission3, transmission1],
            name = "Major I80 Accident",
            description="**Markdown Valid**",
            agency=[agency1, agency3]
        )
        incident1.save()
        ...
        incident2: Incident = Incident.objects.create(
            active=True,
            time=datetime.now()-timedelta(min=5),
            system=system1,
        ...
        incident3: Incident = Incident.objects.create(
            active=True,
            time=datetime.now()-timedelta(min=15),
            system=system2,
            transmission = [],
            name = "Drug Bust",
            description="**Markdown Valid**",
        ...
        default_talkgroup_acl: TalkGroupACL = TalkGroupACL.objects.create(
            ...
            allowed_talkgroups=TalkGroup.objects.filter(system=system1),
            default_new_talkgroups = True,
            default_new_users = True,
            download_allowed=False,
            transcipt_allowed = False
        )
        ...
        restricted_talkgroup_acl: TalkGroupACL = TalkGroupACL.objects.create(
            ...
            allowed_talkgroups=TalkGroup.objects.filter(system=system2),
            default_new_talkgroups = True,
        ...
        scanlist2: ScanList = ScanList.objects.create(
            ...
            talkgroups = TalkGroup.objects.filter(system=system1),
            notes = "**MARKDOWN READY**"
        )
        scanlist2.save()
        ...
        scanlist3: ScanList = ScanList.objects.create(
            ...
            public=False,
            community_shared = False,
            talkgroups = TalkGroup.objects.filter(alpha_tag__icontains="Lincoln FD"),
            notes = "**MARKDOWN READY**"
        )
        scanlist3.save()
        ...
        scanlist4: ScanList = ScanList.objects.create(
            ...
            public=True,
            community_shared = False,
            talkgroups = TalkGroup.objects.filter(alpha_tag__icontains="Troop"),
            notes = "**MARKDOWN READY**"
        )
        scanlist4.save()
        ...
        scanner2: Scanner = Scanner.objects.create(
            ...
            public=True,
            community_shared = False,
            scanlists = [default_scanlist, scanlist2, scanlist3,scanlist4],
            notes = "**MARKDOWN READY**"
        )
        scanner2.save()
